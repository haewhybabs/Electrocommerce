                ...
                <div class="col-sm-12 col-md-8 col-md-offset-2 c-col-add-new-pg">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-body">
                            ...
                            <!-- Form -->
                            <?php echo form_open_multipart('product/single_product_specification'); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="productName" class="form-control" value="<?= $products->productName; ?>" readonly="">
                                            <input type="hidden" name="prod_id" class="form-control" value="<?= $products->prod_id; ?>" readonly="">
                                        </div>
                                    </div>
