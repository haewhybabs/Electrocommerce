...
<script src="<?php echo base_url(); ?>assets/assetpack/bootstrap.js"></script>
...
<script src="http://localhost/eattohealth-ems/view/private/assets/js/app.js"></script>
                ...
                <div class="col-sm-12 col-md-8 col-md-offset-2 c-col-add-new-pg">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-body">
                            ...
                            <!-- Form -->
                            <form action="<?php echo base_url(); ?>product/add_product" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="shortProductDesc" id="" cols="30" rows="3" class="form-control" required="true"></textarea>
                                </div>

                                <!-- Product Description -->
                                <div class="form-group">
                                    <label for=""> Full Description </label>
                                    <textarea name="fullProductDesc" id="" cols="30" rows="7" class="form-control summernote" required="true"></textarea>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="productPrice" class="form-control" required="true">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="userfile" class="filestyle"
                                            data-buttonname="btn-success" data-buttontext=" &nbsp;Upload product image"
                                            required="true" id="filestyle-0"
