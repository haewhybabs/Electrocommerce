                ...
                <div class="col-sm-12 col-md-8 col-md-offset-2 c-col-add-new-pg">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-body">
                            ...
                            <!-- Form -->
                            <form action="<?= base_url('product/update_specification'); ?>" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="" class="form-control" value="<?= $specData->product; ?>" readonly="">
                                        <input type="hidden" name="specification_id" class="form-control" value="<?= $specData->specification_id; ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="specification" class="form-control" value="<?= $specData->specification; ?>" required="true">
                                    </div>
                                </div>
                            </div>
