...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url(); ?>assets/assetpack/style.css" rel="stylesheet">
                            ...
                            <div class="widget stay-on-collapse" id="widget-sidebar">
                                <nav role="navigation" class="widget-body">
                                    <ul class="acc-menu">
                                        ...
                                        <!-- Products Menu -->
                                        <li class="hasChild"><a href="javascript:;"> <i class="fa fa-cubes"></i> <span> Products </span></a>
                                            <!-- Products Sub Menu -->
                                            <ul class="acc-menu">
                                                <li> <a href="<?= site_url('product/product_overview'); ?>"> <span> Product Overview </span> </a> </li>
                                                <li> <a href="<?= site_url('product/product_inventory'); ?>"> <span> Product Inventory </span> </a> </li>
                                                <li> <a href="<?= site_url('product/product_category'); ?>"> <span> Product Categories </span> </a> </li>
                                                <li> <a href="<?= site_url('product/product_specification'); ?>"> <span> Product Specifications </span> </a> </li>
                                            </ul>
                                        </li>

                                        <!-- Client orders -->
                                        <li class="hasChild"><a href="javascript:;"> <i class="ti-shopping-cart-full"></i> <span> Orders </span></a>
                                            <ul class="acc-menu">
                                                <li> <a href="<?= site_url('orders/product_overview'); ?>"> Manage Orders </a> </li>
                                            </ul>
                                        </li>

                                        <!-- Directories Menu -->
                                        <li class="hasChild"><a href="javascript:;"><i class="fa fa-delicious"></i> <span> Directories </span></a>
                                            <!-- Directories Sub Menu -->
                                            <ul class="acc-menu">
                                                <li> <a href="#"> <span> Directory Overview </span> </a> </li>
                                                <li> <a href="#"> <span> Directory Entries </span> </a> </li>
                                                <li> <a href="#"> <span> Directory Categories </span> </a> </li>
                                            </ul>
                                        </li>

                                        <!-- Users Menu -->
                                        <li class="hasChild"><a href="javascript:;"> <i class="fa fa-users"></i> <span> User Management </span></a>
                                            <!-- Directories Sub Menu -->
                                            <ul class="acc-menu">
                                        ...
                                        <li><?php echo anchor(site_url('user/logout'), '<i class="fa fa-sign-out"></i><span>Logout</span>'); ?></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                    ...
                    <footer role="contentinfo">
                        <div class="clearfix">
                            <ul class="list-unstyled list-inline pull-left">
                                <li><h6 style="margin: 0;">&copy; <?php echo date('Y'); ?> Gadget Hub. By Xown Solutions Ltd</h6></li>
