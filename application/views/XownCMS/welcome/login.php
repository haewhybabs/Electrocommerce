...
<html lang="en" class="coming-soon">
    <head>
        <meta charset="utf-8">
        <title>Xown CMS | Gadgethub</title>
            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <div class="panel panel-default">
                        ...
                        <!-- Login form -->
                        <form action="<?php echo base_url('user/login'); ?>" class="form-horizontal" id="validate-form" method="POST">
                                ...
                                <div class="form-group mb-md">
                                    <div class="col-xs-12">
                                        <div class="input-group">							
                                            ...
                                            <input type="email" name="email" class="form-control" placeholder="Email" data-parsley-minlength="6" placeholder="At least 6 characters" required>
                                        </div>
                                    </div>
                                </div>
