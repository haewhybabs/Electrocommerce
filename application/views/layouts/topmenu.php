...
$("#demo").rTabs();
      ...
      <div class="container">
          ...
          <div class="right-sec">
              <ul>
                  ...
                  <li><a href="#">Welcome <?= $this->session->userdata('logged_user')['username']; ?></a></li>
                  <li><a href="<?= base_url(); ?>user/logout_user">Logout</a></li>

                  <?php else : ?>
                  <li><a href="<?= base_url(); ?>user">Login/Register </a></li>
                  <?php endif; ?>
  ...
  <!-- Header -->
  <header>
      <?php $cats = $this->ProductModel->GetCategory(); ?>
      <div class="container" style="margin-top:-9px;">
          <div class="logo"> <a href="index-2.html"><img
                      src="<?php echo base_url(); ?>public_assets/images/logo-small.png" alt=""
                      style="width:70px; height:60px; margin-top:-17px;"></a> </div>
          ...
          <!-- Cart Part --><?php $items = $this->cart->contents(); ?>
          <ul class="nav navbar-right cart-pop">
              <li class="dropdown"> <a href="<?= base_url(); ?>shoppingcart/cart_view" class="dropdown-toggle"
                      data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span
                          class="itm-cont"><?= count($this->cart->contents()); ?></span> <i
                          class="flaticon-shopping-bag"></i> <strong>My Cart</strong> <br>
                      <span><?= count($items); ?> item(s)</span></a>
                  ...
                  <ul class="dropdown-menu">
                      ...
                      <li>
                          ...
                          <div class="media-body"> <a href="#." class="tittle"><?= $item['name']; ?></a>
                              <span>N <?= number_format($item['price'], 2); ?></span> </div>
                      </li>
                      <?php endforeach; ?>
                      <li class="btn-cart"> <a href="<?= base_url(); ?>shoppingcart/cart_view" class="btn-round">View
                              Cart</a> </li>
                  </ul>
                  <?php endif; ?>
              </li>
      ...
      <!-- Nav -->
      <nav class="navbar ownmenu" style="height:57px; ">
          <div class="container">
              ...
              <div class="collapse navbar-collapse" id="nav-open-btn">
                  <ul class="nav">
                      <li class="dropdown megamenu active"> <a href="<?= base_url(); ?>">Home </a>
                      ...
                      <li class="dropdown"> <a href="<?= base_url(); ?>product/all_products/0">Products
                          </a>
                          ...
                          <div class="dropdown-menu animated-2s fadeInUpHalf">
                              <div class="mega-inside">
                                  ...
                                  <div class="container">
                                      ...
                                      <div class="row">
                                          <?php $data = $this->ProductModel->get_all_cateogory();
                                            //$total = count_all_category();
                                            for ($i = 0; $i < 30; $i += 10) : ?>
                                          <div class="col-sm-3">
                                              ...
                                              <ul>
                                                  ...
                                                  <li><a
                                                          href="<?= base_url(); ?>product/all_products/<?= $data[$i + $p]->id; ?>"><?= $data[$i + $p]->title; ?></a>
                                                  </li>
                                                  <?php endfor; ?>
                                          ...
                                          <div class="col-sm-3">
                                              ...
                                              <ul>
                                                  ...
                                                  <li><a
                                                          href="<?= base_url(); ?>product/all_products/<?= $data[$i + $j]->id; ?>"><?= $data[$i + $j]->title; ?></a>
                                                  </li>
                                                  <?php endfor; ?>
                                          ...
                                          <div class="col-sm-2">
                                              <ul>
                                                  ...
                                                  <li><a
                                                          href="<?= base_url(); ?>product/all_products/<?= $data[$i + $t]->id; ?>"><?= $data[$i + $t]->title; ?></a>
                                                  </li>
                                                  <?php endfor; ?>
                                          ...
                                          <div class="col-sm-4"> <img class=" nav-img"
                                                  src="<?php echo base_url(); ?>public_assets/images/navi-img.png"
                                                  alt="">
                                          </div>
                                      </div>
                                  </div>
  ...
  <div class="container">
      ...
      <?php
        ...
        if ($this->session->userdata('message') <> '') {
            echo '<br><div class="alert alert-dismissable alert-info">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
