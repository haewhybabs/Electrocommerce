        ...
        Buttons = function(a) {
            var b = this,
                ...
                h = this.representShortcut = function(a) {
                    var b = g[a];
                    return e.shortcuts && b ? (agent.isMac && (b = b.replace("CMD", "âŒ˜").replace("SHIFT", "â‡§")), b = b.replace("BACKSLASH", "\\").replace("SLASH", "http://themesdesign.in/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]"), " (" + b + ")") : ""
                };
            this.initialize = function() {
